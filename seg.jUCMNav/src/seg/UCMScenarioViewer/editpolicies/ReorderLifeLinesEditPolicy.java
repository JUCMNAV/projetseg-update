 ...
 */
package seg.UCMScenarioViewer.editpolicies;
...
import seg.UCMScenarioViewer.commands.ReorderLifeLinesCommand;
...
/**
 * A drag and drop edit policy that is installed on <code>seg.UCMScenarioViewer.editpart.tree.LifeLineTreeEditPart</code>
 ...
 * @link seg.UCMScenarioViewer.commands.ReorderLifeLinesCommand that 
...
public class ReorderLifeLinesEditPolicy extends AbstractEditPolicy {
	 ...
	 * model element the <code>seg.UCMScenarioViewer.model.AbstractModelElement.number</code>
