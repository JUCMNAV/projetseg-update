...
public class StartEndMessage extends DoElement {
	...
	/* (non-Javadoc)
	 * @see seg.UCMScenarioViewer.model.AbstractModelElement#getInitialLocation()
	 */
	...
	/* (non-Javadoc)
	 * @see seg.UCMScenarioViewer.model.AbstractModelElement#getXdimension()
	 */
	...
	/* (non-Javadoc)
	 * @see seg.UCMScenarioViewer.model.AbstractModelElement#getYdimension()
	 */
