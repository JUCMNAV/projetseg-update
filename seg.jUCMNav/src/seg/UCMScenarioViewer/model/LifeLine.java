...
public class LifeLine extends AbstractModelElement {
	...
	/* (non-Javadoc)
	 * @see seg.UCMViewer.model.AbstractModelElement#getTreeChildren()
	 */
	...
	/* (non-Javadoc)
	 * @see seg.UCMViewer.model.AbstractModelElement#invalidateCoordinates()
	 */
	...
	/* (non-Javadoc)
	 * @see seg.UCMViewer.model.AbstractModelElement#invalidateDimensions()
	 */
	...
	/* (non-Javadoc)
	 * @see seg.UCMScenarioViewer.model.AbstractModelElement#fireRefreshEvent()
	 */
	...
	/* (non-Javadoc)
	 * @see seg.UCMScenarioViewer.model.AbstractModelElement#applyFont(java.lang.String, int, int)
	 */
