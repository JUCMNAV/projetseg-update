			...
			for(Object urnLink: urnspec.getUrnLinks()){
				...
				if(IER.getId() == strGetFromElem){
					...
					if(nodeTemp!= null && nodeTemp.Node instanceof IntentionalElementRef){
						...
						infoCommentUrlLinks += countElement++ + "- urnLink Type : " + ((URNlink) urnLink).getType() +
								"\n     => Source=" + strGetFromElem + " - Name: " + IER.getDef().getName() +
								" - GRLGraph: " + ((grl.GRLGraph)IER.getDiagram()).getName() + 
								"\n     => Target=" + strGetToElem + " - " +  toElemIER.getDef().getName() +
								" - GRLGraph: " + ((grl.GRLGraph)toElemIER.getDiagram()).getName() + "\n";
									...
									if(elem instanceof IntentionalElementRef){
										...
										if(elemIER.getId() == strGetToElem){
											...
											infoCommentUrlLinks += countElement++ + "- urnLink Type : " + ((URNlink) urnLink).getType() +
													...
													" - GRLGraph: " + ((grl.GRLGraph)elemIER.getDiagram()).getName() +"\n";
											foundUrnLinks = true;
										}						
										...
										if(respRef.getId() == strGetToElem){
											...
											infoCommentUrlLinks += countElement++ + "- urnLink Type : " + ((URNlink) urnLink).getType() +
													...
													" - UCMmap: " + ((ucm.map.UCMmap)((IURNDiagram)respRef.getDiagram())).getName() +"\n";
											//print String
											foundUrnLinks = true;
										}
										...
										if(li.getLink() instanceof Contribution
											...
											if(li.getLink().getId() == strGetToElem){
												...
												infoCommentUrlLinks += countElement++ + "- urnLink Type : " + ((URNlink) urnLink).getType() +
														...
														" - GRLGraph: " + ((grl.GRLGraph)li.getDiagram()).getName()+"\n";
												foundUrnLinks = true;
											}
									}
									...
									if(elem instanceof ActorRef){
										...
										if(actorRef.getId() == strGetToElem){
											...
											infoCommentUrlLinks += countElement++ + "- urnLink Type : " + ((URNlink) urnLink).getType() +
													...
													" - GRLGraph: " + ((grl.GRLGraph)actorRef.getDiagram()).getName() + "\n";
											foundUrnLinks = true;
										}
										...
										if(compRef.getId() == strGetToElem){
											...
											infoCommentUrlLinks += countElement++ + "- urnLink Type : " + ((URNlink) urnLink).getType() +
													...
													" - UCMmap: " + ((UCMmap)compRef.getDiagram()).getName() + "\n";
											foundUrnLinks = true;
										}
									}
							}
				...
				// this Part check urnLinks [ ToElem to FromElem ]
					...
					if(nodeTemp!= null && nodeTemp.Node instanceof IntentionalElementRef){
						...
						infoCommentUrlLinks += countElement++ + "- urnLink Type : " + ((URNlink) urnLink).getType() +
								...
								" - GRLGraph: " + ((grl.GRLGraph)fromtoElemIER.getDiagram()).getName() + 
												...
												if(li_.getLink() instanceof Contribution
													...
													if(li_.getLink().getId() == strGetToElem){
														...
														infoCommentUrlLinks += countElement++ + "- urnLink Type : " + ((URNlink) urnLink).getType() +
																...
																" - GRLGraph: " + ((grl.GRLGraph)li_.getDiagram()).getName()+"\n";
														foundUrnLinks = true;
													}
											}
